...
public interface ExtendedSMVPackage extends EPackage
{
   ...
   * @ordered
   */
  int INTEGER_DECLARION__NAME = VARIABLE_DECLARATION__NAME;
   ...
   * @ordered
   */
  int INTEGER_DECLARION_FEATURE_COUNT = VARIABLE_DECLARATION_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int BOOLEAN_DECLARION__NAME = VARIABLE_DECLARATION__NAME;
   ...
   * @ordered
   */
  int BOOLEAN_DECLARION_FEATURE_COUNT = VARIABLE_DECLARATION_FEATURE_COUNT + 0;
   ...
   * @generated
   */
  int STATE_VARIABLE_DECLARATION = 7;
   ...
   * @ordered
   */
  int STATE_VARIABLE_DECLARATION__STATES = VARIABLE_DECLARATION_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int STATE_VARIABLE_DECLARATION_FEATURE_COUNT = VARIABLE_DECLARATION_FEATURE_COUNT + 1;
  ...
  /**
   * Returns the meta object for the attribute '{@link org.xtext.osy.extendedSMV.VariableDeclaration#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see org.xtext.osy.extendedSMV.VariableDeclaration#getName()
